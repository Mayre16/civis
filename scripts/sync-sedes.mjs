/**
 * Sincroniza las sedes del sitio principal hacia Civis (build-time).
 *
 * Prioridad de fuente:
 * 1. CMS publicado (NEXT_PUBLIC_CMS_URL / CMS_URL) — CI y producción
 * 2. Archivos locales del monorepo (editor/ o principal/)
 *
 * Genera lib/civis-sedes.generated.ts. Regenerar: npm run sedes:sync
 */
...
const OUT = path.join(ROOT, "lib/civis-sedes.generated.ts");
